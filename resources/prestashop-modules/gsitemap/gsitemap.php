...
class Gsitemap extends Module
{
    ...
    public function getContent()
    {
        ...
        $store_url = "https://www.dolcezampa.com";
        ...
        */
        ...
        foreach ($products_id as $product_id) {
            ...
            if (!$this->addLinkToSitemap($link_sitemap, [
                ...
                'link' => str_replace('https://aidyis-prod-backoffice.dolcezampa.com', 'https://www.dolcezampa.com', $url),
    ...
    protected function recursiveSitemapCreator($link_sitemap, $lang, &$index)
    {
        ...
        foreach ($link_sitemap as $file) {
            ...
            // if contains ?controller=module continu
            if (strpos($file['link'], '?controller=module') !== false) {
                continue;
            }
