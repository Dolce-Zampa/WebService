...
define('_DZ_AMOUNT_FREE_SHIPPING_', 89);

define('_PS_API_RATE_LIMIT_', false);
define('_PS_API_RATE_LIMIT_REQUEST_', 100);    // Numero di richieste
define('_PS_API_RATE_LIMIT_TIME_WINDOW_', 60); // Finestra in secondi
define('_PS_LAZY_IMAGE_DELETION_', true);
